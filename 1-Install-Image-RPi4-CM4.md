...
> See later in this section for Fedora 'arm-image-installer' tests
...
# Make the usboot tool
   1. Download usbboot from github source
```
...
> creating an alias to see all the folder information is easy. You may add this to your ~/.bash_aliases 
```
